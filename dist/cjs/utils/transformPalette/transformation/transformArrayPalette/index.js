...
var transformArrayPalette = function transformArrayPalette(paletteObj) {
  var validatedPalette = (0, _validateArrayPalette["default"])(paletteObj);
  var transformedPalette = validatedPalette.palette.map(function (color) {
    return _objectSpread(_objectSpread({}, color), {}, {
      values: (0, _transformShades["default"])(color.values)
    });
  });
  return {
...
var _default = exports["default"] = transformArrayPalette;